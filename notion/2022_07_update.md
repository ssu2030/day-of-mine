...
### 2022.07.29
##### 데이터스토어 변수 뷰 데이터 로직 수정
- 현재수정부분 구현 근데 첫 init이 string 이라 변환 필요
##### 면담준비 - 정리필요

### 2022.08.02
##### react suspense 및 면담준비를 위한 학습
- 기존했던 프로젝트에 suspense 적용해보기
##### 새로진행하는 프로젝트 figma 작성
- https://www.figma.com/file/JXKsolWnhmnAekcuSGZSCK/Untitled?node-id=3%3A3
